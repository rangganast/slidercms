...
urlpatterns = [
    ...
    path('smsblast/generate_random_number_add', views.GenerateRandomContactViewAdd.as_view(), name='generate_random_contact_add'),
    path('smsblast/generate_csv_add', views.GenerateCSVContactViewAdd.as_view(), name='generate_csv_add'),
    path('smsblast/temp_random_contacts_add', views.TempRandomContactViewAdd.as_view(), name='temp_random_contacts_add'),
    path('smsblast/temp_csv_contacts_add', views.TempCSVContactViewAdd.as_view(), name='temp_csv_contacts_add'),

    path('smsblast/update_contact_group/<str:pk>', views.UpdateContactGroupView.as_view(), name='smsblast_update_contact_group'),
    path('smsblast/update_random_generated_numbers/<str:pk>', views.UpdateRandomGeneratedNumbersView.as_view(), name='smsblast_update_random_generated_numbers'),
    path('smsblast/generate_random_number_update', views.GenerateRandomContactViewUpdate.as_view(), name='generate_random_contact_update'),
    ...
    path('ajax/check-contact-name-update', views.check_contact_name_update, name='ajax_check_contact_name_update'),
